...
_WFI_SCA_LAYOUT = {
     ...
     2: ( -22.29, -37.03, 180.0),
     3: ( -22.44, -82.06,   0.0),
     4: ( -67.36,  21.84, 180.0),  # left 0.94, up 0.94
     5: ( -66.92, -28.28, 180.0),
     6: ( -67.42, -73.06,   0.0),
     7: (-111.64,  43.14, 180.0),  # left 0.94, up 0.94
     8: (-112.42,  -6.04, 180.0),  # left 0.94, up 0.94
     9: (-113.58, -50.12,   0.0),  # left 0.94
    10: (  22.14,  12.15, 180.0),
    11: (  22.29, -37.03, 180.0),
    12: (  22.44, -82.06,   0.0),
    13: (  65.48,  21.84, 180.0),  # right 0.94, up 0.94
    14: (  66.92, -28.28, 180.0),
    15: (  67.42, -73.06,   0.0),
    16: ( 109.76,  43.14, 180.0),  # right 0.94, up 0.94
    17: ( 112.42,  -6.04, 180.0),  # right 0.94
    18: ( 112.64, -51.06,   0.0),
}
